...
const ForgotPassword = () => {
    ...
    useEffect(() => {
        document.title = "SocialSculptor | Forgot Password"
    }, [])


    // if (isAuthenticated) { return <Navigate to={"/dashboard"} replace /> }

    const handleSubmit = async (e) => { // Remove 'e' from the parameter list
        e.preventDefault();
        toastStart("Trying...")
        try {
            const response = await api.post(`/v01/password-reset/forgot-password`,
                {
                    email,
                }, {
                headers: {
        ...
        <Box sx={{ backgroundColor: "#E6F0FF", minHeight: "100vh" }}>
            ...
            <CustomBox>
                ...
                >
                    ...
                    <CustomButton backgroundColor="#0F1B4C" color="#fff" buttonText="Send Reset Link" heroBtn={true} type={"submit"} />
                </Box>
